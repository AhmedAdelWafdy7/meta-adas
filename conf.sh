...
echo "LICENSE_FLAGS_ACCEPTED += \"synaptics-killswitch commercial\"" >> $CONF
echo "IMAGE_INSTALL:append = \" wpa-supplicant iw wireless-regdb rfkill linux-firmware-bcm43430\"" >> $CONF
